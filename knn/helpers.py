"""
Visualization and helper utilities for KNN models.

This module contains functions for visualizing KNN results including
decision surfaces, confusion matrices, and digit samples.
"""
